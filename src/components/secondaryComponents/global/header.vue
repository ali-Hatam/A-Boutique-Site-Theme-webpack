...
onMounted(() => {
  ...
  //   // this.refSlider.parentElement.style.top = "86px";
  // }, data.option1);
  ...
  //   // this.refSlider.parentElement.style.top = "0";
  // }, data.option2);
  ...
  // this.observer_2.observe(headerSec.value.children[0]);
  // this.observer_1.observe(headerMenu.value);
});

// props: {
//   refOfSliderComp: Object,
// },
...
var displaySearchBox = () => {
  ...
  data.body.style.overflowY = "scroll";
